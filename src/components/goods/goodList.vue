<template>
  <div class="goods-list">
    <div class="goods-item" v-for="item in goodslist" :key="item.id" @click="goDetail(item.id)">
      <img src="https://img20.360buyimg.com/mobilecms/s80x80_jfs/t7582/66/3048380492/71753/acde79b5/59b85824N836bb714.jpg!q90.webp" alt="">
...
export default {
  ...
  methods: {
    getGoodsList() {
      ...
      this.$http.get('api/getgoods?pageindex='+this.pageindex+'&count='+this.count).then(res=>{
        console.log(res);
